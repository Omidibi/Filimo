    ...
    override fun onBindViewHolder(holder: SingleVideoVH, position: Int) {
        holder.apply {
            ...
            cvSingleVideo.setOnClickListener {
                val videoList = Video(relatedInfo.catId,"","",relatedInfo.categoryName,"",relatedInfo.id,relatedInfo.rateAvg,relatedInfo.totalViewer,relatedInfo.videoDescription,relatedInfo.videoDuration,relatedInfo.videoId,relatedInfo.videoThumbnailB,relatedInfo.videoThumbnailS,relatedInfo.videoTitle,relatedInfo.videoType,relatedInfo.videoUrl)
